...
cc=document.getElementById("w"+i) ;
 ...
 document.getElementById('newcat').innerHTML=Noquots(ccc);
 sessionStorage.setItem("pharase",Noquots(ccc));
...
window.location="deafreader.php";
...
analyseit();
//	window.location="deafreader.html";
}
...
function writeback()
{
	...
	ss=document.getElementById("newcatkot").value;
	document.getElementById("newcat").value=Noquots(ss);
               //sessionStorage.setItem("pharase",ss);
	writetosign();
...
//  if(param.length>0)
//  {
//  var xx= param.indexOf("&");
//  if(xx>0) arr= param.split("&");  else arr.push(param);
//  
//
//  for (var i=0;i<arr.length;i++) {
//    var temp = arr[i].split("=");
//    outputarr.push(temp[1]);
//    }
//  }
//	return outputarr;
//}
...
//	var qq=GetParam();
//	
//if(qq.length>0)	document.getElementById("newcatkot").value= qq[0];
//}